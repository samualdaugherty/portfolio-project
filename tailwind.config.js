  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'hero-drop-shadow': '15.999px 32.249px 75px 0px rgba(0,0,0,0.15), 10.37px 20.902px 43.924px 0px rgba(0,0,0,0.11), 6.163px 12.422px 23.889px 0px rgba(0,0,0,0.09), 3.2px 6.45px 12.188px 0px rgba(0,0,0,0.08), 1.304px 2.628px 6.111px 0px rgba(0,0,0,0.06), 0.296px 0.597px 2.951px 0px rgba(0,0,0,0.04)'
      }
    }
  },
  plugins: [
