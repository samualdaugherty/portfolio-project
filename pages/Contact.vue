          ...
          >
            ...
            <div>
              ...
              <input 
                ...
                class="w-full px-4 py-3 border border-black dark:border-white bg-white dark:bg-black text-black dark:text-white font-lato text-body rounded-lg focus:border-2 focus:outline-none focus:border-accent transition-colors disabled:opacity-50"
            ...
            <div>
              ...
              <textarea 
                ...
                rows="5"
                :disabled="isSubmitting"
                class="w-full px-4 py-3 border border-black dark:border-white bg-white dark:bg-black text-black dark:text-white font-lato text-body rounded-lg focus:border-2 focus:outline-none focus:border-accent transition-colors resize-vertical disabled:opacity-50"
