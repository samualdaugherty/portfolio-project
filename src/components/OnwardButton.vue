<template>
  <router-link
    :to="to"
    class="onward-btn group border border-accent rounded-full h-12 w-12 overflow-hidden px-0 focus:outline-none bg-transparent relative flex items-center no-underline"
    aria-label="Onward"
  ...
  >
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="35" height="24" viewBox="0 0 35 24" fill="none" class="w-8 h-8 text-black dark:text-white">
